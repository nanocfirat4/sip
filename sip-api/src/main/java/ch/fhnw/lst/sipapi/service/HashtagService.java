...
public class HashtagService {
    ...
    public List<Hashtag> findAll(){
        ...
        for (Hashtag hashtag:allHashtags) {
            ...
            if(hashtag.getHashtagCount()==0){hashtagRepository.delete(hashtag);}
        }
        List<Hashtag> correctedHashtags = hashtagRepository.findAll();
        correctedHashtags.sort((h1, h2) -> Integer.compare(h2.getHashtagCount(), h1.getHashtagCount()));
